...
for slice_number = 1:nr_slices
    ...
    fid = fopen(fullfile(output_path, sprintf('reconstruction_time_pclr_slc%d.txt', slice_number)), 'w');
    ...
    fig_filename = sprintf('img_maxgirf_pclr_slc%d_%s_gridding%d_phc%d_cfc%d_sfc%d_gnc%d_topup%d_i%d_l%4.2f', slice_number, slice_type, gridding_flag, phc_flag, cfc_flag, sfc_flag, gnc_flag, topup_flag, maxiter, lambda);
